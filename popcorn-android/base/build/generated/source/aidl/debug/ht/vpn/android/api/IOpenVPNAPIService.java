 ...
 * Original file: F:\\AndrodiStudio Projects\\popcorn-android\\base\\src\\main\\aidl\\ht\\vpn\\android\\api\\IOpenVPNAPIService.aidl
 */
package ht.vpn.android.api;
public interface IOpenVPNAPIService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements ht.vpn.android.api.IOpenVPNAPIService
{
private static final java.lang.String DESCRIPTOR = "ht.vpn.android.api.IOpenVPNAPIService";
...
/**
 * Cast an IBinder object into an ht.vpn.android.api.IOpenVPNAPIService interface,
 * generating a proxy if needed.
 */
public static ht.vpn.android.api.IOpenVPNAPIService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof ht.vpn.android.api.IOpenVPNAPIService))) {
return ((ht.vpn.android.api.IOpenVPNAPIService)iin);
}
return new ht.vpn.android.api.IOpenVPNAPIService.Stub.Proxy(obj);
}
...
java.util.List<ht.vpn.android.api.APIVpnProfile> _result = this.getProfiles();
...
case TRANSACTION_isConnectedOrConnecting:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isConnectedOrConnecting();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
ht.vpn.android.api.IOpenVPNStatusCallback _arg0;
_arg0 = ht.vpn.android.api.IOpenVPNStatusCallback.Stub.asInterface(data.readStrongBinder());
...
ht.vpn.android.api.APIVpnProfile _result = this.addNewVPNProfile(_arg0, _arg1, _arg2);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
private static class Proxy implements ht.vpn.android.api.IOpenVPNAPIService
{
...
@Override public java.util.List<ht.vpn.android.api.APIVpnProfile> getProfiles() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<ht.vpn.android.api.APIVpnProfile> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getProfiles, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(ht.vpn.android.api.APIVpnProfile.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public void startVPN(java.lang.String name, java.lang.String inlineconfig) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public boolean isConnectedOrConnecting() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isConnectedOrConnecting, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
/**
      ...
      */
@Override public void registerStatusCallback(ht.vpn.android.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public void unregisterStatusCallback(ht.vpn.android.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/** Use a profile with all certificates etc. embedded */
@Override public ht.vpn.android.api.APIVpnProfile addNewVPNProfile(java.lang.String name, boolean userEditable, java.lang.String config) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
ht.vpn.android.api.APIVpnProfile _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(name);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = ht.vpn.android.api.APIVpnProfile.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
static final int TRANSACTION_isConnectedOrConnecting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_registerStatusCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_unregisterStatusCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_removeProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_protectSocket = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_addNewVPNProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
}
public java.util.List<ht.vpn.android.api.APIVpnProfile> getProfiles() throws android.os.RemoteException;
...
/** start a profile using a config as inline string. Make sure that all needed data is inlined,
	 * e.g., using <ca>...</ca> or <auth-user-data>...</auth-user-data>
	 * See the OpenVPN manual page for more on inlining files */
public void startVPN(java.lang.String name, java.lang.String inlineconfig) throws android.os.RemoteException;
/** This permission framework is used  to avoid confused deputy style attack to the VPN
	 * calling this will give null if the app is allowed to use the external API and an Intent
	 * that can be launched to request permissions otherwise */
...
public boolean isConnectedOrConnecting() throws android.os.RemoteException;
/**
      * Registers to receive OpenVPN Status Updates
      */
public void registerStatusCallback(ht.vpn.android.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException;
/**
     * Remove a previously registered callback interface.
     */
public void unregisterStatusCallback(ht.vpn.android.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException;
/** Remove a profile by UUID */
...
/** Use a profile with all certificates etc. embedded */
public ht.vpn.android.api.APIVpnProfile addNewVPNProfile(java.lang.String name, boolean userEditable, java.lang.String config) throws android.os.RemoteException;
}
